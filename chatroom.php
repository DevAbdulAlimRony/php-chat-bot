...
<head>
  <link rel="icon" type="image/x-icon" href="https://cdn1.dan.com/assets/public/benefits-transfers-374cef9ae50af8a199e7054cfe5092643d1c7659965fb9480022e0487d467606.svg" size="16*16">
    <title>FriendsChat | Chat Room</title>
	<!-- Bootstrap core CSS -->
...
<body>
	...
	<div class="container">
	<!-- <img src="images/Corona Cover Photo.png" alt="" width="100%" height="250"> -->
		<div class="row">
					...
					<div class="card-header">
						<div class="row">
							<div class="col col-sm-6 d-flex">
								<img src="images/phone.png" alt="" height="50" width="50">
								<h3>Chat Room</h3>
							</div>
				...
				<form method="post" id="chat_form" data-parsley-errors-container="#validation_error">
					<div class="input-group mb-3">
						...
						<div class="input-group-append">
							<button type="submit" name="send" id="send" class="btn btn-primary send"><i class="fa fa-paper-plane"></i></button>
						</div>
					</div>
